...
const AvatarSelector = () => {
  ...
  return (
    <div className={"relative xl:-mt-[300px] pb-[1100px]"}>
      ...
      <div
        className="hidden xl:block absolute left-1/2 bottom-[100%] h-[240px] w-[1px]"
        style={{
      ...
      <PageSection
        ...
        className={"overflow-visible pt-[60px] left-0 w-full pb-0"}
      >
        <div className="absolute left-1/2 top-0" id={'chkp4'}/>
        <div className="hidden xl:block absolute left-0 top-0 h-full bg-purple w-[1px]" id={'chkp5'}>
          <div
